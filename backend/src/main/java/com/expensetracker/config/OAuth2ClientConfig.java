...
/**
 * Programmatic OAuth2 client registration configuration. Only creates registrations when OAuth
 * environment variables are set. This avoids Spring Boot's auto-configuration failing with empty
 * client IDs.
 */
@Configuration
