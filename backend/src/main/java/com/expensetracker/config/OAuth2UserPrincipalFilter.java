...
/**
 * Filter that converts OAuth2AuthenticationToken to UsernamePasswordAuthenticationToken
 * with a UserPrincipal, so that all existing controllers can continue using
        ...
        if (auth instanceof OAuth2AuthenticationToken oauthToken) {
            ...
            if (userPrincipal != null) {
                UsernamePasswordAuthenticationToken newAuth =
                    new UsernamePasswordAuthenticationToken(userPrincipal, null, oauthToken.getAuthorities());
