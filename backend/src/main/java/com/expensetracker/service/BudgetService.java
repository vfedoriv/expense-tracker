...
public class BudgetService {
    ...
    /**
     * Creates or updates a budget for the given user+year+month (upsert). Returns the response and
    ...
    public UpsertResult createOrUpdateBudget(Long userId, BudgetRequest request) {
        ...
        Optional<MonthlyBudget> existing =
        ...
        if (existing.isPresent()) {
            ...
            // Reset alert state when budget amount changes so thresholds are re-evaluated from
            // scratch
