...
class TransactionServiceTest {
    ...
    void updateTransaction_categoryNotOwned_throwsNotFound() {
        ...
        Transaction existingTransaction =
                createTransactionEntity(
                        1L, "Old title", new BigDecimal("50.00"), LocalDate.of(2026, 3, 10), null);
        when(transactionRepository.findByIdAndUserId(1L, 1L))
                .thenReturn(Optional.of(existingTransaction));
        when(categoryRepository.findByIdAndUserId(99L, 1L)).thenReturn(Optional.empty());
    ...
    void deleteTransaction_success() {
        Transaction existingTransaction =
                createTransactionEntity(
                        1L, "Test", new BigDecimal("50.00"), LocalDate.of(2026, 3, 15), null);
        when(transactionRepository.findByIdAndUserId(1L, 1L))
                .thenReturn(Optional.of(existingTransaction));
    ...
    void listTransactions_noFilters() {
        ...
        Transaction txn2 =
                createTransactionEntity(
                        2L, "Gas", new BigDecimal("40.00"), LocalDate.of(2026, 3, 14), null);

        when(transactionRepository.findAllByUserIdWithFilters(
                        eq(1L), eq(null), eq(null), eq(null), eq(null), eq(null), eq(null)))
                .thenReturn(List.of(txn1, txn2));

        List<TransactionResponse> result =
                transactionService.listTransactions(1L, null, null, null, null, null, null);
    ...
    void listTransactions_withSearch() {
        ...
        when(transactionRepository.findAllByUserIdWithFilters(
                        eq(1L), eq("groc"), eq(null), eq(null), eq(null), eq(null), eq(null)))
                .thenReturn(List.of(txn1));

        List<TransactionResponse> result =
                transactionService.listTransactions(1L, "groc", null, null, null, null, null);
    ...
    void listTransactions_withCategoryFilter() {
        Transaction txn1 =
                createTransactionEntity(
                        1L, "Groceries", new BigDecimal("52.75"), LocalDate.of(2026, 3, 15), null);

        when(transactionRepository.findAllByUserIdWithFilters(
                        eq(1L), eq(null), eq(10L), eq(null), eq(null), eq(null), eq(null)))
                .thenReturn(List.of(txn1));

        List<TransactionResponse> result =
                transactionService.listTransactions(1L, null, 10L, null, null, null, null);
    ...
    void listTransactions_withDateRange() {
        ...
        when(transactionRepository.findAllByUserIdWithFilters(
                        eq(1L), eq(null), eq(null), eq(dateFrom), eq(dateTo), eq(null), eq(null)))
                .thenReturn(List.of(txn1));

        List<TransactionResponse> result =
                transactionService.listTransactions(1L, null, null, dateFrom, dateTo, null, null);
    ...
    void listTransactions_withAmountRange() {
        ...
        List<TransactionResponse> result =
                transactionService.listTransactions(
                        1L, null, null, null, null, amountMin, amountMax);
    ...
    void createTransaction_pastMonth_evaluatesAlertsForThatMonth() {
        ...
        Transaction savedTransaction =
                createTransactionEntity(
                        1L, "Past purchase", new BigDecimal("500.00"), pastDate, null);
        when(transactionRepository.save(any(Transaction.class))).thenReturn(savedTransaction);
    ...
    void updateTransaction_evaluatesAlertsForTransactionDate() {
        ...
        Transaction existingTransaction =
                createTransactionEntity(
                        1L, "Old title", new BigDecimal("50.00"), transactionDate, null);
        when(transactionRepository.findByIdAndUserId(1L, 1L))
                .thenReturn(Optional.of(existingTransaction));
        when(categoryRepository.findByIdAndUserId(10L, 1L)).thenReturn(Optional.of(testCategory));
        ...
        Transaction savedTransaction =
                createTransactionEntity(
                        1L, "Updated", new BigDecimal("100.00"), transactionDate, null);
        when(transactionRepository.save(any(Transaction.class))).thenReturn(savedTransaction);
    ...
    void deleteTransaction_evaluatesAlertsForDeletedTransactionDate() {
        ...
        Transaction existingTransaction =
                createTransactionEntity(1L, "Test", new BigDecimal("50.00"), transactionDate, null);
        when(transactionRepository.findByIdAndUserId(1L, 1L))
                .thenReturn(Optional.of(existingTransaction));
    ...
    private Transaction createTransactionEntity(
            Long id, String title, BigDecimal amount, LocalDate transactionDate, String notes) {
