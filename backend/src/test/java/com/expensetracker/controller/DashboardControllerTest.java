    ...
    void setUp() throws Exception {
        ...
        MvcResult catResult =
                mockMvc.perform(
                        ...
                        .andReturn();
        user1CategoryId =
                ((Number) JsonPath.read(catResult.getResponse().getContentAsString(), "$.id"))
                        .longValue();
    }
    ...
    void getDashboard_noBudget_withTransactions_returnsTotalSpentAndNullBudget() throws Exception {
        ...
        mockMvc.perform(
                        post("/api/transactions")
                                ...
                                .content(
                                        transactionJson(
                                                "DashTest Groceries", "50.00", "2098-03-15")))
                .andExpect(status().isCreated());
    ...
    void getDashboard_withBudgetAndTransactions_returnsCorrectCalculations() throws Exception {
        ...
        mockMvc.perform(
                        post("/api/transactions")
                                ...
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(
                                        transactionJson("DashTest Dinner", "100.00", "2098-05-15")))
                .andExpect(status().isCreated());
    ...
    void getDashboard_overspent_returnsNegativeRemaining() throws Exception {
        ...
        mockMvc.perform(
                        post("/api/transactions")
                                ...
                                .content(
                                        transactionJson(
                                                "DashTest Big Expense", "300.00", "2098-06-10")))
                .andExpect(status().isCreated());
    ...
    void getDashboard_crossUserIsolation_transactionsNotShared() throws Exception {
        ...
        mockMvc.perform(
                        post("/api/transactions")
                                ...
                                .content(
                                        transactionJson(
                                                "DashTest User1 Item", "100.00", "2098-07-15")))
                .andExpect(status().isCreated());
        ...
        mockMvc.perform(
                        post("/api/transactions")
                                ...
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(
                                        "{\"title\": \"DashTest User2 Item\", \"amount\": 200.00, \"transactionDate\": \"2098-07-15\", \"categoryId\": "
                                                + user2CategoryId
                                                + "}"))
                .andExpect(status().isCreated());
    ...
    void getDashboard_transactionsInDifferentMonth_notCounted() throws Exception {
        ...
        mockMvc.perform(
                        post("/api/transactions")
                                ...
                                .content(
                                        transactionJson(
                                                "DashTest Aug Item", "100.00", "2098-08-15")))
                .andExpect(status().isCreated());
        ...
        mockMvc.perform(
                        post("/api/transactions")
                                ...
                                .content(
                                        transactionJson(
                                                "DashTest Sep Item", "200.00", "2098-09-15")))
                .andExpect(status().isCreated());
